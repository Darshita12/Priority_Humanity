...
<script>
	...
	function chg(){
		...
		var url = "DependentCity?valajax=" + val;
                ...
                <div class="navbar-collapse justify-content-end" id="navbarToggler">
                    <ul class="navbar-nav">
                        <li class="nav-item">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="NGOListController1">Donate</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="NGOListController">Search Ngos</a>
                            </li>
                           <%
						...
						<li class="nav-item">
                            ...
                            <li class="nav-item active">
                                <a class="nav-link active" href="register.jsp">SignUp</a>
                            </li>
                            <%
						if (session.getAttribute("AdminType") != null){
							boolean AdminType = (Boolean)session.getAttribute("AdminType");
						...
						%>
						<li class="nav-item"><a class="nav-link"
							href="UserListController">Actions</a></li>
							<% }}%>
                             <li class="nav-item">
        ...
        <div class="navbar-collapse justify-content-end" id="navbarToggler">
            ...
            <ul class="navbar-nav text-uppercase">
                        <li class="nav-item active">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="SearchNgo.jsp">Search Ngos</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="UpcomingEvents.jsp">Events</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="login.jsp">Login</a>
                            </li>
    ...
    <div class="main">
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form" style="margin-left: 320px">
                    <form method="POST" class="register-form" id="register-form" name='registration' onSubmit="return formValidation();" action="UpdateUserController" >
                        <% UserBean userBean=(UserBean)request.getAttribute("UserBean"); %>
                       
						<input type="hidden" name="txtUserId" value="<%=userBean.getUserId()%>">
                 
                        <div style="background-color: #ff6801;">
                            <h2 style="color: white;font-weight: 2px;padding-bottom: 4px;margin-left: 2px;">User Edition form</h2>
                        </div>
                        <div class="form-row">
                            <div class="form-group">
                                <label for="txtFirstName">First Name :<span style="color: red">*</span></label>
                                <input type="text" name="txtFirstName" value="<%=userBean.getFirstName()%>" required/>
                            </div>
                            <div class="form-group">
                                <label for="txtLastName">Last Name :<span style="color: red">*</span></label>
                                <input type="text" name="txtLastName" value="<%=userBean.getLastName()%>" required/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="txtUserEmail">Email Id :<span style="color: red">*</span></label>
                            <input type="text"  name="txtUserEmail" value="<%=userBean.getEmail()%>" required/>
                        </div>
                         <div class="form-group">
                            <label for="txtUserPassword">Password:<span style="color: red">*</span></label>
                            <input type="text"  name="txtUserPassword" value="<%=userBean.getPassword()%>"  required/>
                        </div>
                        <div class="form-group">
                            <label for="txtConfirmPassword">Confrim Password:<span style="color: red">*</span></label>
                            <input type="text"  name="txtUserPassword" value="<%=userBean.getPassword()%>" required/>
                        </div>
                         <div class="form-group">
                            <label for="txtUserContact">Contact:<span style="color: red">*</span></label>
                            <input type="text" name="txtUserContact" value="<%=userBean.getContact()%>" required/>
                        </div>
                        <div class="form-radio">
                        <label for="gender" class="radio-label">Gender :<span style="color: red">*</span></label>
                        ...
                        <div class="form-row">
                            <div class="form-group">
                                ...
                                <div class="form-select">
                                     <select name="stateName" id="one" onchange="chg()">
 ...
 <footer class="ftco-footer ftco-bg-dark ftco-section" style="background-color: #224480;">
    <div class="container">
      ...
      <div class="row">
       ...
       <script src="loginvalidation.js" charset="utf-8"></script>
        <!-- JS -->
