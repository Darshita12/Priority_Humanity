            ...
            <div class="modal-login">
                <div class="modal-content">
                    <div class="modal-header">        
                        <h4 class="modal-title"><b style="color: #111142;">Forget Password</b></h4><br/>
                    </div>
                    <h6 class="modal-title" style="text-align: center;"><b>You can reset your password here</b></h6>
                    <div class="modal-body">
                        <form method="post" action="SendMail" name='registration' onSubmit="return formValidation();">
                            <div class="form-group">
                                <i class="fa fa-user"></i>
                                <input type="text" class="form-control" name="to" placeholder="Enter Email" required="required" data-parsley-type="email" data-parsley-trigger="keyup">
                            </div>
                         
                            <div class="form-group">
                                <input type="submit" class="btn btn-primary btn-block btn-lg" value="Proceed Securely">
                            </div>
                    </form>       
                        
                    </div>
                    <div class="modal-footer">
                        Did you remember?<a href="register.jsp">Signup</a>
                    </div>
                </div>
            </div>
        </div>
