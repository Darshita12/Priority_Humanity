                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="column-wrapper ngo-section flex justify-content-center align-items-center">
                            <a href="NGOLogin.jsp">
                                <button class="button button-primary">NGO Login</button>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="column-wrapper user-section flex justify-content-center align-items-center">
                            <a href="UserLogin.jsp">
                                <button class="button button-primary">User Login</button>
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="column-wrapper user-section flex justify-content-center align-items-center">
                            <a href="AdminLogin.jsp">
                                <button class="button button-primary">Admin Login</button>
                            </a>
                        </div>
                    </div>
                </div>
      ...
      <div class="row mb-5">
        <div class="col-md">
          <div class="ftco-footer-widget mb-5">
              ...
              <li><a href="index.jsp" style="color: white;">Home</a></li><br/>
              <li><a href="index.jsp" style="color: white;">About us</a></li><br/>
              <li><a href="index.jsp" style="color: white;">Contact us</a></li><br/>
