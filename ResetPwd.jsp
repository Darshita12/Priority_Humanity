            ...
            <div class="modal-login">
                <div class="modal-content">
                    <div class="modal-header">        
                        <h4 class="modal-title"><b style="color: #111142;">Reset Password</b></h4><br/>
                    </div>
                    <h6 class="modal-title" style="text-align: center;"><b>You can reset your password here</b></h6>
                    <div class="modal-body">
                        <form method="post" action="ForgetPwdController" name='registration' onSubmit="return formValidation();">
                            <div class="form-group">
                                <i class="fa fa-user"></i>
                                <input type="number" class="form-control" name="uid" placeholder="Enter Id" required="required" data-parsley-type="email" data-parsley-trigger="keyup">
                            </div>
                            <div class="form-group">
                                <i class="fa fa-lock"></i>
                                <input type="password" class="form-control" name="pwdPassword" placeholder="New Password" required="required"  data-parsley-length="[6, 10]" data-parsley-trigger="keyup">                   
                            </div>
                            <div class="form-group">
                                <i class="fa fa-lock"></i>
                                <input type="password" class="form-control" name="pwdPassword" placeholder="Confirm Password" required="required"  data-parsley-length="[6, 10]" data-parsley-trigger="keyup">                   
                            </div>
                    ...
                    <div class="modal-footer">
                        Did you remember?<a href="register.html">Signup</a>
                    </div>
                </div>
            </div>
        </div>
