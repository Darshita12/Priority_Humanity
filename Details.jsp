...
<li class="nav-item"><a class="nav-link" href="Login.jsp">Login</a>
        ...
        <div class="side-nav overlay">
            <div class="navbar-collapse justify-content-end" id="navbarToggler">
                ...
                <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="SearchNgo.html">Search Ngos</a>
                        </li>
                        <li class="nav-item">
        ...
        <section class="information-section">
            <div class="container">
                <h2 class="text-uppercase">Detailed information</h2>

                <div class="information-wrapper">
                    <h3><b>About Org</b></h3>

                    <div class="flex">
                        <h4 class="info-title w-100">NGO Name :</h4>
                        <p class="w-100" style="color: red;"><b>Blind Welfare Council Dahod</b></p>

                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Popular Name :</h4>
                        <p class="w-100">   Blind Welfare Council - Dahod</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Year of Establishment :</h4>
                        <p class="w-100">2000</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Full Time Staff :</h4>
                        <p class="w-100">148</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Full Time Volunteers :</h4>
                        <p class="w-100">0</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Brief Description :</h4>
                        <p class="w-100">   
Education, Training, Welfare, all round development of all persons with disabilities about 5000 persons with disabilities are covered under our several projects</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Organisation Website:</h4>
                        <p class="w-100">http://www.bwcdahod.com</p>
                    </div>
                </div>
            </div>
        </section>
         ...
         <section class="information-section">
            <div class="container">
                ...
                <div class="information-wrapper">
                    ...
                    <div class="flex">
                        <h4 class="info-title w-100">NGO Name :</h4>
                        <p class="w-100" style="color: red;"><b>Shikshan Ane Samaj Kalyan Kendra</b></p>

                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Popular Name :</h4>
                        <p class="w-100">   sskkamreli</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Year of Establishment :</h4>
                        <p class="w-100">1980</p>
                    </div>
                    ...
                    <div class="flex">
                        <h4 class="info-title w-100">Brief Description :</h4>
                        <p class="w-100">   
Shikshan Ane Samaj Kalyan Kendra is an organisation successful in helping society through various activities in agriculture, health, education, women empowerment, etc. It is doing its best with a vision to give the livelihood opportunities to people with various effective activities and programmes.</p>
                    </div>

                    <div class="flex">
                        <h4 class="info-title w-100">Organisation Website:</h4>
                        <p class="w-100">http://www.sskkamreli.org/</p>
                    </div>
                </div>
            </div>
        </section>
