	...
	<div class="side-nav overlay">
		<div class="navbar-collapse justify-content-end" id="navbarToggler">
			...
			<ul class="navbar-nav text-uppercase">
				...
				<li class="nav-item"><a class="nav-link" href="SearchNgo.jsp">Search Ngos</a></li>
				<li class="nav-item"><a class="nav-link" href="EventListController">Events</a></li>
				<li class="nav-item active"><a class="nav-link"	href="Login.jsp">Login</a></li>
				<li class="nav-item"><a class="nav-link" href="register.jsp">SignUp</a>
				</li>
			</ul>
		...
		<div class="modal-login">
			<div class="modal-content">
				<div class="modal-header">
                        <h4 class="modal-title"><b style="color: #111142;">Login</b></h4>
				</div>
				<div class="modal-body">
					<form action="AdminLoginController" method="POST" name='registration' onSubmit="return formValidation();">

						<div class="form-group">
							<i class="fa fa-user"></i> <input type="text" name="txtAdminEmail"
								class="form-control" placeholder="Username" required="required">
						</div>
						<div class="form-group">
							<i class="fa fa-lock"></i> <input type="password"
								name="txtAdminPassword" class="form-control" placeholder="Password"
								required="required">
						</div>
						<div class="form-group">
