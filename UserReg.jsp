        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form" style="margin-left: 320px">
                    <form method="POST" class="register-form" id="register-form" name='registration' onSubmit="return formValidation();" action="UserInsertController" >
                        <div style="background-color: #ff6801;">
                            <h2 style="color: white;font-weight: 2px;padding-bottom: 4px;margin-left: 2px;">User registration form</h2>
                        </div>
                        <div class="form-row">
