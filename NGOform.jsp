        ...
        <div class="container" >
            <div class="signup-content">
                ...
                <div class="signup-form" style="margin-left: 280px;">
                    <form method="POST" class="register-form" id="register-form" action="NGOInsertControllerr"  enctype="multipart/form-data">
                        <div>
...
<%} %>
                        ...
                        <!-- <div class="form-group">
                            <label for="address">Major Activities/Achievemnets:</label>
                             <textarea cols="40" rows="5" name="NGOdetails"></textarea><br/>
                        ...
                        <div style="background-color: #ff6801;">
						 ...
						 <div class="form-group">
                            <label for="email">Upload NGO Certificate:</label>
