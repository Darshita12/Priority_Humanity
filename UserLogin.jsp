		...
		<div class="modal-login">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="UserLoginController" method="POST" name='registration' onSubmit="return formValidation();">

						<div class="form-group">
							<i class="fa fa-user"></i> <input type="text" name="txtUserEmail"
								class="form-control" placeholder="Username" required="required">
						</div>
						<div class="form-group">
							<i class="fa fa-lock"></i> <input type="password"
								name="txtUserPassword" class="form-control" placeholder="Password"
								required="required">
						</div>
						<div class="form-group">
